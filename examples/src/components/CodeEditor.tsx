...
export const CodeEditor: React.FC<CodeEditorProps> = ({ code, onChange, theme = 'light' }) => {
  ...
  return (
    <div style={{ width: '100%', height: '100%', position: 'relative', display: 'flex', backgroundColor: bgColor }}>
      <div
        ref={lineNumbersRef}
        style={{
          width: '40px',
