...
Defined in: [charts/src/chart/HeatmapChart.ts:7](https://github.com/pangkaiguo/HudX/blob/2231bfb72b0675f521ece07b0c55e6a4ee11805d/packages/charts/src/chart/HeatmapChart.ts#L7)
...
> **new HeatmapChart**(`dom`, `option?`, `renderMode?`, `theme?`, `locale?`): `HeatmapChart`
