...
Defined in: [charts/src/chart/ScatterChart.ts:20](https://github.com/pangkaiguo/HudX/blob/5318c1432ccbb01469da04d48c3f66df5dc53246/packages/charts/src/chart/ScatterChart.ts#L20)
...
> **new ScatterChart**(`dom`, `option?`, `renderMode?`, `theme?`, `locale?`): `ScatterChart`
