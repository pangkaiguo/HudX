...
Defined in: [charts/src/chart/DoughnutChart.ts:3](https://github.com/pangkaiguo/HudX/blob/5318c1432ccbb01469da04d48c3f66df5dc53246/packages/charts/src/chart/DoughnutChart.ts#L3)
...
> **new DoughnutChart**(`dom`, `option?`, `renderMode?`, `theme?`, `locale?`): `DoughnutChart`
