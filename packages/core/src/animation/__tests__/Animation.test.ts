...
describe('Animation', () => {
  ...
  describe('Easing Functions', () => {
    ...
    it('should test specific branches in easing functions', () => {
      ...
      expect(Easing.cubicInOut(0.6)).toBeCloseTo((0.6 - 1) * (2 * 0.6 - 2) ** 2 + 1);
      ...
      expect(Easing.exponentialInOut(0.25)).toBeCloseTo(Math.pow(2, 20 * 0.25 - 10) / 2);
      expect(Easing.exponentialInOut(0.75)).toBeCloseTo((2 - Math.pow(2, -20 * 0.75 + 10)) / 2);
  ...
  describe('Control Flow', () => {
    ...
    it('should pause and resume', () => new Promise<void>((resolve) => {
      const target = { x: 0 };
    ...
    it('should loop in animate when paused', () => new Promise<void>((resolve) => {
      const target = { x: 0 };
      const anim = new Animation(target, 'x', 100, 100);
      anim.start();
      anim.pause();
  ...
  describe('Deep Property Access', () => {
    it('should animate nested property', () => new Promise<void>((resolve) => {
    ...
    it('should create missing nested properties on set', () => new Promise<void>((resolve) => {
      const target: any = {};
    ...
    it('should stop setting if path is blocked by non-object', () => new Promise<void>((resolve) => {
      const target = { a: 1 };
